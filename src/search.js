...
import './geo.css'
//import PropTypes from 'prop-types'
//import Places from 'react-select-places'
...
renderHtml = (suggest) => {
return console.log(suggest.description.split[","])
}
...
suggest
    ...
    return (<div>{suggest.description}<p className={`${"flag flag-pk"}`}></p></div>)
...
onSuggestSelect(suggest) {
    ...
    console.log(suggest);
 if(suggest){ 
    this.props.handleCords(suggest.location)
    }
  }
